...
{
	public void sendMail(String string, String month)
	{				
			String memberName = "";
			...
			for(Object[] abc : memList)
			{
				...
				try
				{
		            ...
		            messageBodyPart.setText("Hello,"+memberName+" \nYour Monthly maintenance by SBA Wise is Rs. "+monthlyContributionCost+" INR for "+month+" month and Pay till "+string);
