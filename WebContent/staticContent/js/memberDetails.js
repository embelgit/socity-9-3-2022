...
// update member details
 ...
 function validationupdateMemberDetails()
 {     
	 ...
	 var firstName = $('#firstName').val();
		...
		if(memberFullName =="" || memberFullName ==null || memberFullName ==undefined)
			{
...
function updateMemberDetails()
{
			...
			if(adharNo=="" || adharNo==null || adharNo==undefined)
			{
				adharNo="N/A";
			}
