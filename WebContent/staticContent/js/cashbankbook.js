...
function valdgetExpensePaymentDetailsBetTwoDays()
{
	var expenseName=$("#expenseName").val();
	var sub_expenseName=$("#sub_ExpenseName").val();
	...
	if(sub_expenseName=="" || sub_expenseName==null || sub_expenseName==undefined)
	{
	alert("please select  sub expenditure name");
	return false;
	}
...
//************ Between Two Dates *************//*
function valdgetExpensePaymentDetailsBetDays()
{
...
function valdgetVendorPaymentDetailsByName()
{
...
function valdgetVendorPaymentDetailsBetDays()
{
...
function valdgetVendorPaymentDetailsForAMCByName()
{
	...
	var endDate = $("#endDate4ForAMC").val();
	 ...
	 getVendorPaymentDetailsForAMCByName();
	}
...
function valdgetVendorPaymentDetailsBetDaysForAMC()
{
	...
	getVendorPaymentDetailsBetDaysForAMC();
	}
...
function valdgetMemberPaymentDetailsForBillingByName()
{
	...
	getMemberPaymentDetailsForBillingByName();
...
function valdgetMemberPaymentDetailsForBillingByDates()
{
	...
	getMemberPaymentDetailsForBillingByDates();
...
function valdgetMemberPaymentDetailsForAMCByName()
{
	...
	getMemberPaymentDetailsForAMCByName();
	}
...
function valdgetMemberPaymentDetailsForAMCByDate()
{
	...
	getMemberPaymentDetailsForAMCByDate();
	}
