...
function  valdannualMaintenanceContractReport()
{
	var annualMaintenanceName = $('#annualMaintenanceName').val();
...
function valdannualMaintenanceFollowUpReport()
{
	var annualMaintenanceFollowUpName = $('#annualMaintenanceFollowUpName').val();
	if(annualMaintenanceFollowUpName=="" || annualMaintenanceFollowUpName==null || annualMaintenanceFollowUpName==undefined)
		{
		alert("please select annual maintenance name");
		return false;
		}
