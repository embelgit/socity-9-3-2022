...
function validationupdateVendorDetail()
{
	...
	if(companyNumber=="" || companyNumber==null || companyNumber==undefined)
		{
		alert("please enter comapny number");
		return false;
		}
...
function updateVendorDetail()
{
	...
	{
		alternateContactNo="N/A";
	}
	
	
	if(emengencyContactNo=="" || emengencyContactNo==null || emengencyContactNo==undefined)
	{
		emengencyContactNo="N/A";
	}
	...
	if(gstInNo=="" || gstInNo==null || gstInNo==undefined)
	{
		gstInNo="N/A";
	}
	...
	if(CIMNo=="" || CIMNo==null || CIMNo==undefined)
	{
		CIMNo="N/A";
	}
