    ...
    <div  class="col-md-12">
        ...
        <div class="col-md-2">
            ...
            <ul class="nav nav-tabs">
                <li class=""><a class="leftmanu" href="#messages" data-toggle="tab" >Employee Payment</a></li>
	...
	<!------------ Employee Payment ---------->
    	     	 ...
    	     	 <div class="row form-group">
          				...
          				<div class="col-md-3">
						    ...
						    <%
							 ...
							 %>
							 	<input list="employeeNameList" id="fk_employee_id" class="form-control" onfocus="this.value=''">
	 ...
	 <script>
		...
		<div class="row form-group">
			   ...
			   <div class="row form-group">
					<label class="col-md-2 control-label" for="reason2">Reason:<sup>*</sup></label>  
	          			<div class="col-md-3">
							<div class="input-group">
								<span class="input-group-addon">
								 <i class="glyphicon glyphicon-hand-right"></i>
 ...
 <!--------------- Client Payment ----------------->
  ...
  <!-----------------------------   Expenditure Payment ------------------------>
       ...
       <div class="tab-pane" id="settings">
		...
		<div class="row form-group">
           	<label class="col-md-2 control-label" for="expenditureName">Expenditure Name<sup>*</sup></label>  
        		 <div class="col-md-3">
           	 	...
           	 	<label class="col-md-2 control-label" for="serviceProvider">Sub Expenditure Name<sup>*</sup></label>  
           			 <div class="col-md-3">
						<div class="input-group">
							<span class="input-group-addon">
								<i class="glyphicon glyphicon-hand-right"></i>
							</span>
								<input list="subExp_drop" id="subExpNameId" class="form-control">
			...
			<div class="row form-group">
				<label class="col-md-2 control-label" for="contactNumber">Service Provider<sup>*</sup></label>  
          			 <div class="col-md-3">
					<div class="input-group">
						<span class="input-group-addon">
							<i class="glyphicon glyphicon-hand-right"></i>
				...
				<label class="col-md-2 control-label" for="expCredit">Contact Number</label>  
          			 <div class="col-md-3">
					<div class="input-group">
						 <span class="input-group-addon">
							<i class="glyphicon glyphicon-hand-right"></i>
				...
				<div class="row form-group">
					<label class="col-md-2 control-label" for="contactNumber">Amount<sup>*</sup></label>  
           			 <div class="col-md-3">
						<div class="input-group">
							  <span class="input-group-addon">
								<i class="fa fa-rupee" style="font-size:18px;width: 27px"></i>
					...
					<label class="col-md-2 control-label" for="expCredit">Accountant Name </label>  
           			 <div class="col-md-3">
						<div class="input-group">
							 <span class="input-group-addon">
								<i class="glyphicon glyphicon-user"></i>
		...
		<div class="form-group row">
            <div class="col-md-10 text-center">
            <input type="button" id="save" name="btn4" style="font-size: 25" class="btn btn-success btn-lg btnn "  onclick="validationExpense()" value="Submit">
		    <input type="reset" id="btn2" style="font-size: 25" class="btn btn-danger btn-lg btnn" name="btn4" value="Cancel">
