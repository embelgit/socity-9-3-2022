				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<div class="input-group">
							...
							<input type="text" id='vendorcompanyname' name="vendorcompanyname" class="form-control" placeholder="Vendor Company Name" readonly="readonly">
						</div>
					</div>
				</div>
			</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<div class="input-group">
						 ...
						 <input type="text" id='contactno' name="contactno" class="form-control" maxlength="10" onkeypress="return isNumber(event)" placeholder="Enter Contact No" readonly="readonly">
						</div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<div class="input-group">
							...
							<textarea rows="2" cols="10", id='companyAddress' name="companyAddress" class="form-control" placeholder="Enter Company Address" readonly="readonly"></textarea>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<div class="input-group">
						 ...
						 <input type="text" id='panNumber' name="panNumber" class="form-control" placeholder="Enter Pan Number" readonly="readonly">
						</div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<div class="input-group">
							...
							<textarea rows="3" cols="40" id='productdescription' class="form-control" placeholder="Enter Product Description" onchange="getGridForProduct();clearCalculation();clearFiled()" ></textarea>
