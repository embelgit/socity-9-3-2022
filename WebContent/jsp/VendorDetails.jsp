...
<body>
	...
	<div class="container-fluid">
		<div class="row header_margin_top">
			<div align="center">
				<h2 class="form-name style_heading" style="margin-top: 80px">Vendor Details</h2>
			</div>
		</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<div class="input-group">
							...
							<input type="text" id='firstName' name="firstName" class="form-control" placeholder="Enter Vendor Name" onkeypress="return isAlphabets(event)" />
						</div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<div class="input-group">
							...
							<input type="text" id='lastName' name="lastName" class="form-control" placeholder="Enter last name" onkeypress="return isAlphabet(event)" />
						</div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<div class="input-group">
							...
							</span> <input type="text" id='companyNumber' name="companyNumber" onkeypress="return isNumber(event)"
