...
<div class="row" style="min-height: 300px;">
					...
					<div id="vendorName" class="tab-pane fade in active">
						<form class="form-horizontal">
					      ...
					      <div class="row form-group buttons_margin_top ">
								<div align="center">
									<input type="button" id="btn" name="save" class="btn btn-lg btn-success btn-md button_hw button_margin_right" onclick="valdgetVendorPaymentDetailsByName()" value="Search" />
								</div>
						  </div>
			       ...
			       <div class="row">
					<div class="form-group">
							...
							<div class="col-md-2 col-sm-offset-1" align="right">
						      ...
						      <div class="row form-group buttons_margin_top ">
									<div align="center">
										<input type="button" id="btn" name="save" class="btn btn-lg btn-success btn-md button_hw button_margin_right" onclick="valdgetVendorPaymentDetailsBetDays()" value="Search" />
									</div>
							  </div>
	...
	<!--+++++++++++++++++++++++++++   Vendor Payment Reports For AMC +++++++++++++++++++++++--->
			...
			<div id="vendorNameWiseForAMC" class="tab-pane fade in active">
			      ...
			      <div class="row form-group buttons_margin_top ">
						<div align="center">
							<input type="button" id="btn" name="save" class="btn btn-lg btn-success btn-md button_hw button_margin_right" onclick="valdgetVendorPaymentDetailsForAMCByName()" value="Search" />
						</div>
				  </div>
			       ...
			       <div class="row">
					<div class="form-group">
							...
							<div class="col-md-2 col-sm-offset-1" align="right">
						      ...
						      <div class="row form-group buttons_margin_top ">
									<div align="center">
										<input type="button" id="btn" name="save" class="btn btn-lg btn-success btn-md button_hw button_margin_right" onclick="valdgetVendorPaymentDetailsBetDaysForAMC()" value="Search" />
									</div>
							  </div>
 ...
 -->
	...
	<!-- ++++++++++++++++++++++++++++++++++	Member Payment reports For Billing ++++++++++++++++++++++++++++++-->
					...
					<form class="form-horizontal" method="post" action="" name="empReport1">
			            ...
			            <div class="row">
							<div class="form-group">
								...
								<div class="row form-group buttons_margin_top ">
									<div align="center">
										<input type="button" id="btn" name="save" class="btn btn-lg btn-success btn-md button_hw button_margin_right" onclick="valdgetMemberPaymentDetailsForBillingByName()" value="Search" />
									</div>
								</div>
			       ...
			       <div class="row">
					<div class="form-group">
							...
							<div class="col-md-2 col-sm-offset-1" align="right">
						      ...
						      <div class="row form-group buttons_margin_top ">
									<div align="center">
										<input type="button" id="btn" name="save" class="btn btn-lg btn-success btn-md button_hw button_margin_right" onclick="valdgetMemberPaymentDetailsForBillingByDates()" value="Search" />
									</div>
							  </div>
					...
					<form class="form-horizontal" method="post" action="" name="empReport1">
			            ...
			            <div class="row">
							<div class="form-group">
								...
								<div class="row form-group buttons_margin_top ">
									<div align="center">
										<input type="button" id="btn" name="save" class="btn btn-lg btn-success btn-md button_hw button_margin_right" onclick="valdgetMemberPaymentDetailsForAMCByName()" value="Search" />
									</div>
								</div>
	...
	<!-----------------------------    Member Name Wise For AMC  --------------------------->
		 ...
		 <div id="home" class="tab-pane fade in active">		
			<form class="form-horizontal">
		      ...
		      <div class="row form-group buttons_margin_top ">
					<div align="center">
						<input type="button" id="btn" name="save" class="btn btn-lg btn-success btn-md button_hw button_margin_right" onclick="valdgetExpensePaymentDetailsBetTwoDays()" value="Search" />
					</div>
			  </div>
		 ...
		 <div id="home" class="tab-pane fade in active">		
			<form class="form-horizontal">
		         <div class="row">
				      ...
				      <div class="row form-group buttons_margin_top ">
							<div align="center">
								<input type="button" id="btn" name="save" class="btn btn-lg btn-success btn-md button_hw button_margin_right" onclick="valdgetExpensePaymentDetailsBetDays()" value="Search" />
							</div>
					  </div>
