					...
					<label class="col-md-3 control-label" for="employeename">Description<sup>*</sup>
						...
						<div class="col-md-8">
							<div class="input-group">
								...
								<textarea rows="3" cols="40" id='description' class="form-control" placeholder="Enter Description" onchange="getHrBillingGrid();clearHrCalculation();clearField()"></textarea>
