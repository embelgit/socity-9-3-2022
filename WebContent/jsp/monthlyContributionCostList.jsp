...
<script type="text/javascript" src="/society/staticContent/js/jquery-1.12.4.js"></script> 
...
<script type="text/javascript"src="/society/staticContent/js/monthlyContribution.js"></script>
   ...
   <div class="container-fluid" style="min-height:300px;">
		...
		<div class="row header_margin_top">
			<div align="center">
				<h2 class="form-name style_heading" style="margin-top: 80px">Monthly Contribution Cost List</h2>
			</div>
		</div>
	...
	<div id="dataTab">
		<table class="table table-bordered table-striped table-condensed cf"
					id="monthlyContributionCostList" class="display"
					style="border: 2px solid black; border-collapse: collapse;">
					<thead>
						<tr>
							<th>Sr No</th>
						    <th>Monthly Contribution Cost</th>
							<th>Date</th>
							<th>Month</th>
							<th>Cut Off Date</th>
						</tr>
