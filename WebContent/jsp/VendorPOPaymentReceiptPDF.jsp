...
<%
	...
	Double balanceAmount = (Double) session.getAttribute("balanceAmount");
	String paidAmount = (String) session.getAttribute("paidAmount");
	String descriptionForPO = (String) session.getAttribute("descriptionForPO");	
	...
	Double gstAmt = 0.0;
		...
		{	
			...
			reports.setEmailId(o[1].toString());
	...
	// For header 
		 ...
		 // Table for table data (Dyanamic)
				...
				PdfPCell table_cell11;
					...
					table_cell11 = new  PdfPCell(new Phrase("Payment Receipt(Received PO)\n\n", font15Bold));
					...
					table_cell11 = new  PdfPCell(new Phrase(""+paidAmount+"\n\n", Normalfont13));
					table_cell11.setHorizontalAlignment(Element.ALIGN_CENTER);
					table_cell11.setBorder(Rectangle.LEFT | Rectangle.RIGHT | Rectangle.BOTTOM | Rectangle.TOP);
					table11.addCell(table_cell11);
					
					table_cell11 = new  PdfPCell(new Phrase("\n\nTotal Amount : "+totalAmount2+"\nBalance Amount : "+balanceAmount, Normalfont15));
					table_cell11.setHorizontalAlignment(Element.ALIGN_LEFT);
					table_cell11.setBorder(Rectangle.LEFT | Rectangle.RIGHT);
					table11.addCell(table_cell11);
					
					table_cell11 = new  PdfPCell(new Phrase("\n\nDescription : "+descriptionForPO, Normalfont15));
					table_cell11.setHorizontalAlignment(Element.ALIGN_LEFT);
					table_cell11.setBorder(Rectangle.LEFT | Rectangle.RIGHT);
					table11.addCell(table_cell11);
