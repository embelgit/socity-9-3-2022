  ...
  <!----------------------- Annual Maintenance Contract Report----------------------->
   ...
   <div class="tab-pane active" id="messages">
	...
	<!-- <form class="form-horizontal"> -->
      ...
      <div class="row form-group buttons_margin_top ">
			<div align="center">
				<input type="button" id="btn" name="save" class="btn btn-lg btn-success btn-md button_hw button_margin_right" onclick="valdannualMaintenanceContractReport()" value="Search" />
			</div>
	  </div>
   ...
   <div class="tab-pane" id="vendor">
	...
	<!-- <form class="form-horizontal"> -->
      ...
      <div class="row form-group buttons_margin_top ">
			<div align="center">
				<input type="button" id="btn" name="save" class="btn btn-lg btn-success btn-md button_hw button_margin_right" onclick="valdannualMaintenanceFollowUpReport()" value="Search" />
			</div>
	  </div>
