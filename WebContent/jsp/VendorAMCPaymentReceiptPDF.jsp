...
<%
	...
	String totalAmount2 = (String)session.getAttribute("totalAmount");
	Double balanceAmount = (Double) session.getAttribute("amount");
	String paidAmount = (String) session.getAttribute("paidAmount");
	String descriptionForAMC = (String) session.getAttribute("description");
	...
	Double gstAmt = 0.0;
		...
		try {
			...
			Query query=session1.createSQLQuery("SELECT first_name, last_name, email_id FROM vendor_details WHERE pk_vendor_details_id =:fkVendorId");
	...
	// For header 
		 ...
		 // Table for table data (Dyanamic)
				...
				PdfPCell table_cell11;
					...
					table_cell11 = new  PdfPCell(new Phrase("Payment Receipt(AMC)\n\n", font15Bold));
					...
					table_cell11 = new  PdfPCell(new Phrase("Amount\n\n", font15Bold));
					table_cell11.setHorizontalAlignment(Element.ALIGN_CENTER);
					table_cell11.setBorder(Rectangle.LEFT | Rectangle.RIGHT | Rectangle.BOTTOM | Rectangle.TOP);
					table11.addCell(table_cell11);
					
					table_cell11 = new  PdfPCell(new Phrase(""+vendorName+"\n\n", Normalfont13));
					table_cell11.setHorizontalAlignment(Element.ALIGN_CENTER);
					table_cell11.setBorder(Rectangle.LEFT | Rectangle.RIGHT | Rectangle.BOTTOM | Rectangle.TOP);
					table11.addCell(table_cell11);
					
					table_cell11 = new  PdfPCell(new Phrase(""+df.format(Double.parseDouble(paidAmount))+"\n\n", Normalfont13));
					table_cell11.setHorizontalAlignment(Element.ALIGN_CENTER);
					table_cell11.setBorder(Rectangle.LEFT | Rectangle.RIGHT | Rectangle.BOTTOM | Rectangle.TOP);
					table11.addCell(table_cell11);
					
					table_cell11 = new  PdfPCell(new Phrase("\n\nTotal Amount : "+df.format(Double.parseDouble(totalAmount2))+"\nBalance Amount : "+df.format(balanceAmount), Normalfont15));
					table_cell11.setHorizontalAlignment(Element.ALIGN_LEFT);
					table_cell11.setBorder(Rectangle.LEFT | Rectangle.RIGHT);
					table11.addCell(table_cell11);
					
					table_cell11 = new  PdfPCell(new Phrase("\n\nDescription : "+descriptionForAMC, Normalfont15));
					table_cell11.setHorizontalAlignment(Element.ALIGN_LEFT);
					table_cell11.setBorder(Rectangle.LEFT | Rectangle.RIGHT);
					table11.addCell(table_cell11);
			...
			// Table for Footer
				...
				PdfPCell table_cell2;
					...
					table_cell2 = new  PdfPCell(new Phrase("BM SHOMA PARADISE ASSOCIATION", font14BoldRED));
					table_cell2.setHorizontalAlignment(Element.ALIGN_CENTER);
					table_cell2.setBorder(Rectangle.NO_BORDER);
					footercn.addCell(table_cell2);
			
					table_cell2 = new  PdfPCell(new Phrase("BM SHOMA PARADISE ASSOCIATION, #470, Near Ryan International School, Brookefiled Kundahalhalli, Bangalore 560037", Normalfont9));
					table_cell2.setHorizontalAlignment(Element.ALIGN_CENTER);
					table_cell2.setBorder(Rectangle.NO_BORDER);
					footercn.addCell(table_cell2);					
					...
					document.close();
 					 ...
 					 try
 					 {						 	
							 List<GetVendorDetailsBean> list122 = venList;
					 				
							for(int i=0;i<list122.size();i++)
							{
								 GetVendorDetailsBean sr=(GetVendorDetailsBean)list122.get(i);
							
								 String emailId = sr.getEmailId();
								 String firstName = sr.getFirstName();
								 String lastName = sr.getLastName();
								 
								 String vendorName2 = firstName+" "+lastName;
				              ...
				              messageBodyPart.setText("Dear,  "+vendorName2);
