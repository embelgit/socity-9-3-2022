...
<script type="text/javascript">
   ...
   <div class="container-fluid" style="min-height:300px;">
			...
			<div align="center">
				<h2 class="form-name style_heading" style="margin-top: 80px">Annual Maintenance Contract List</h2>
			</div>
		</div>
	...
	<div id="demo_jui">
	   <table class="table table-bordered table-striped table-condensed cf"
			id="annualMaintenanceContractList" class="display" style="border: 2px solid black; border-collapse: collapse;">
			<thead>
			<tr>
