					...
					<div class="col-sm-3">
						<div class="input-group">
							<span class="input-group-addon"> <i
								...
								class="form-control" placeholder="Enter Flat No" style="text-transform:uppercase" onkeypress="return isNumber(event)">
						</div>
					</div>
				</div>
			</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<div class="input-group">
							...
							<input type="text" id='sba' name="sba" class="form-control textInput" placeholder="Enter built up area" onkeypress="return isNumber(event)"/>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<div class="input-group">
							<span class="input-group-addon"> <i
								class="glyphicon glyphicon-hand-right"></i>
							</span> <input type="text" id='education' name="education" onkeypress="return isAlphabetsWithSpace(event)"
