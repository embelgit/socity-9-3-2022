...
<%-- <%@page import="com.society.bean.GetEmployeeDetailsBean"%>
...
<head>
   ...
   <div class="container-fluid" style="min-height:300px;">
		...
		<div class="row header_margin_top">
			<div align="center">
				<h2 class="form-name style_heading" style="margin-top: 80px">Expenditure Payment List</h2>
			</div>
		</div>
	...
	<div id="date">
		...
		<table class="table table-bordered table-striped table-condensed cf"
					id="expPaymentList" class="display"
