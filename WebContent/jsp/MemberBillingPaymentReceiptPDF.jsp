...
<%
	...
	String memberId = (String)session.getAttribute("fkMemberId2");
	String memberName = (String)session.getAttribute("memberName");
	String totalAmount2 = (String)session.getAttribute("totalAmount2");
	Double balanceAmount2 = (Double) session.getAttribute("balanceAmount2");
	String paidAmount2 = (String) session.getAttribute("paidAmount2");
