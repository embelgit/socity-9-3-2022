...
<%@page import="com.society.hibernate.ServentDetailsHibernate"%>
<%@page import="com.society.dao.ServentDetailsDao"%>
<html>
<head>
<meta charset="utf-8">
	    ...
	    <script src="/society/staticContent/js/serventDetails.js"></script>
             ...
             <script type="text/javascript">
				 function back()
				 {
					window.location = "ServentDetails.jsp";
				 }
          	 </script>
...
<body onLoad="notifyMe()">
	...
	<div class="container-fluid">
		<div class="row header_margin_top">
			<div align="center">
				<h2 class="form-name style_heading" style="margin-top: 80px">Edit Servant Details</h2>
			</div>
		</div>
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-2 col-sm-offset-1" align="right">
						<label class="control-label">Servant Name:<sup>*</sup></label>
					</div>
					<div class="col-sm-3">
						<div class="input-group">
							<span class="input-group-addon"> <i
							 ...
							 ServentDetailsDao dao = new ServentDetailsDao();
								List sList4 = dao.getAllServanNamesForEdit();
							 %>
							 	<input list="servantNameList" id="pk_servant_id" class="form-control" onchange="getServantDetailsForEdit()">
								<datalist id="servantNameList">
								 <%
										for (int i = 0; i < sList4.size(); i++) 
										{
											ServentDetailsHibernate sup = (ServentDetailsHibernate) sList4.get(i);
								 %>

									<option data-value="<%=sup.getPkServentId()%>"
...
<%-- 							 <input type="date" id='joiningDate' name="joiningDate" value=<%=todayDate %> class="form-control"> --%>
			...
			<div class="container" align="center">
				<input type="button" class="btn btn-success btn-lg btnn" id="updateBtn" name="updateBtn" value="Update1" onclick="validationUpdateServantDetails()">
				<input type="button" class="btn btn-danger btn-lg btnn" value="Cancel" onclick="reset()">
				<input type="button" class="btn btn-primary btn-lg btnn"  id="backBtn" value="Back" onclick="back()">			
			</div>
		</form>
		</div>
	</div>
