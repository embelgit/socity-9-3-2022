	...
	<form class="form-horizontal" method="post" action="" name="dates">
 	...
 	<div id="home" class="tab-pane fade in active">		
      ...
      <div class="row form-group buttons_margin_top ">
			<div align="center">
				<input type="button" id="btn" name="save" class="btn btn-lg btn-success btn-md button_hw button_margin_right" onclick="valdgetVisitorReportBetTwoDate()" value="Search" />
			</div>
	  </div>
